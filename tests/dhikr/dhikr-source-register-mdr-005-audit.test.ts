...
function testOnlyMdr005ResearchFieldsChanged() {
  ...
  assert(
    ...
    `Expected ${baseline.length} records besides MDR-005/MDR-006/MDR-007/MDR-008/MDR-009/MDR-010–030, found ${otherRecords.length}`,
  );
  ...
  console.log(
    "✓ only MDR-005 changed in this stage; MDR-001 through MDR-004 match checkpoint 3729062 exactly (MDR-006 through MDR-009, MDR-010–020, and MDR-021–030 verified separately)",
  );
}
...
// MDR-010 through MDR-030 are entirely covered by testOnlyMdr005ResearchFieldsChanged's
