      ...
      <Leaf>
        <div className="measure-wide">
          ...
          <header className="programme-header">
            <p className="type-micro programme-header__tier">{programme.tier}</p>
            ...
            <dl className="programme-header__meta">
              ...
              <div>
                <dt className="type-micro">Format</dt>
              ...
              <div>
                <dt className="type-micro">Next cohort</dt>
        ...
        <div className="measure-wide monograph-layout">
          ...
          <article className="monograph-layout__reading measure">
            <section id="overview" className="monograph-section">
              <SectionLabel>What it is · For whom · What it asks</SectionLabel>
              <h2 className="monograph-section__title">Overview</h2>
              <h3 className="programme-subheading">What it is</h3>
              ...
              {programme.faculty.map((member) => (
                <article key={member.name} className="faculty-card">
                  ...
                  {member.biography.map((para) => (
                    <p key={para.slice(0, 40)} className="type-body faculty-card__bio">
                      {para}
                    </p>
                  ))}
                </article>
            ...
            <section id="clinical" className="monograph-section">
              <SectionLabel>Clinical practice</SectionLabel>
              <h2 className="monograph-section__title">Clinical practice</h2>
              <ul className="monograph-list">
            ...
            <section id="testimonials" className="monograph-section">
              ...
              <p className="type-small" style={{ color: "var(--muted)", marginBottom: "var(--s5)" }}>
                Published with consent. Initials used unless the graduate requested otherwise.
              </p>
            ...
            <section id="enrolment" className="dispensation-block enrolment-block">
              ...
              <h2 className="monograph-section__title">Application</h2>
              <p className="type-body" style={{ marginBottom: "var(--s5)" }}>
                {programme.feeNote} Read the programme in full before applying. The faculty
                reviews each application; acceptance is a clinical and academic judgement.
              </p>
